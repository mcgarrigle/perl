...
case "$perladmin" in
'') perladmin='root@forge7.foo.local' ;;
esac
...
case "$prefix" in
'') prefix='/root/perl5/perlbrew/perls/perl-5.10.1' ;;
esac
...
case "$siteprefix" in
'') if test "/root/perl5/perlbrew/perls/perl-5.10.1" = "/root/perl5/perlbrew/perls/perl-5.10.1"; then
	siteprefix="$prefix"
    else
	siteprefix='/root/perl5/perlbrew/perls/perl-5.10.1'
    fi
    ;;
esac
case "$vendorprefix" in
'') if test "" = "/root/perl5/perlbrew/perls/perl-5.10.1"; then
	vendorprefix="$prefix"
    else
	vendorprefix=''
    fi
...
'') if test "/root/perl5/perlbrew/perls/perl-5.10.1" = "/root/perl5/perlbrew/perls/perl-5.10.1"; then
	...
	installprefix='/root/perl5/perlbrew/perls/perl-5.10.1'
    fi
    ;;
esac
...
#     /root/perl5/perlbrew/perls/perl-5.10.1, so it isn't included here either.
#
...
# bin='/root/perl5/perlbrew/perls/perl-5.10.1/bin'
# scriptdir='/root/perl5/perlbrew/perls/perl-5.10.1/bin'
# privlib='/root/perl5/perlbrew/perls/perl-5.10.1/lib/5.10.1'
# archlib='/root/perl5/perlbrew/perls/perl-5.10.1/lib/5.10.1/x86_64-linux'
# man1dir='/root/perl5/perlbrew/perls/perl-5.10.1/man/man1'
# man3dir='/root/perl5/perlbrew/perls/perl-5.10.1/man/man3'
# Preserving custom html1dir
html1dir=' '
# Preserving custom html3dir
html3dir=' '
# sitebin='/root/perl5/perlbrew/perls/perl-5.10.1/bin'
# sitescript='/root/perl5/perlbrew/perls/perl-5.10.1/bin'
# sitelib='/root/perl5/perlbrew/perls/perl-5.10.1/lib/site_perl/5.10.1'
# sitearch='/root/perl5/perlbrew/perls/perl-5.10.1/lib/site_perl/5.10.1/x86_64-linux'
# Preserving custom siteman1dir
siteman1dir='/root/perl5/perlbrew/perls/perl-5.10.1/man/man1'
# Preserving custom siteman3dir
siteman3dir='/root/perl5/perlbrew/perls/perl-5.10.1/man/man3'
